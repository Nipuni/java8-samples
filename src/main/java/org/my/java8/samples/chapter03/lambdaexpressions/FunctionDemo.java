...
/**
 * User: Nipuni Perera
 * This class demonstrates the usage of lambda expressions with function as functional interfaces.
 */
public class FunctionDemo {
    public static void main (String [] args) {
        ...
        Function<Employee, Integer> getAge = (Employee employee) -> employee.getAge();
